...
?>
<link rel="stylesheet" type="text/css" href="/theme/basic/css/default.css">
...
<link href="https://fonts.googleapis.com/css?family=Do+Hyeon|Nanum+Brush+Script|Noto+Sans+KR" rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Noto+Serif+KR" rel="stylesheet">
<<style>
/* nanum-brush-script-regular - korean_latin */
@font-face {
  font-family: 'Nanum Brush Script';
  font-style: normal;
  font-weight: 400;
  src: url('../fonts/nanum-brush-script-v12-korean_latin-regular.eot'); /* IE9 Compat Modes */
  src: local('Nanum Brush Script'), local('NanumBrush'),
       url('../fonts/nanum-brush-script-v12-korean_latin-regular.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
       url('../fonts/nanum-brush-script-v12-korean_latin-regular.woff2') format('woff2'), /* Super Modern Browsers */
       url('../fonts/nanum-brush-script-v12-korean_latin-regular.woff') format('woff'), /* Modern Browsers */
       url('../fonts/nanum-brush-script-v12-korean_latin-regular.ttf') format('truetype'), /* Safari, Android, iOS */
       url('../fonts/nanum-brush-script-v12-korean_latin-regular.svg#NanumBrushScript') format('svg'); /* Legacy iOS */
}
...
<!-- 콘텐츠시작 -->
<div id="title_01">
<div class="title_01_01"><p>&nbsp;&nbsp;&nbsp;진단</p></div>
